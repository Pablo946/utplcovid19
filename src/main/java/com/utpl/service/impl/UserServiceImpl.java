...
import com.utpl.entity.UserRole;
import com.utpl.repository.UserRepository;
...
public class UserServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String userName) throws UsernameNotFoundException {
        com.utpl.entity.User user = userRepository.findByUserName(userName);
        List<GrantedAuthority> authorities = buildAutorities(user.getUserRols());
        return buildUser(user, authorities);
    }

    private User buildUser(com.utpl.entity.User user, List<GrantedAuthority> authorities) {
